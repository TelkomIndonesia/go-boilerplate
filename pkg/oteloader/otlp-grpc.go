...
func withTraceOTLPGRPCExporter(ctx context.Context, l log.Logger, opts ...otlptracegrpc.Option) func() {
...
func withLogOTLPGRPCExporter(ctx context.Context, l log.Logger, opts ...otlploggrpc.Option) func() {
