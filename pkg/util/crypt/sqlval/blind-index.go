...
var _ BIDXFunc[crypt.PrimitiveBIDX] = (*crypt.DerivableKeyset[crypt.PrimitiveBIDX])(nil).GetPrimitiveFunc(nil)

type BIDXFunc[B crypt.BIDX] func() (B, error)
type BIDXReadWrapper func([][]byte) driver.Valuer
type BIDX[T any, B crypt.BIDX] struct {
	bidxFunc  BIDXFunc[B]
...
func BIDXString[B crypt.BIDX](f BIDXFunc[B], s string) BIDX[string, B] {
...
func BIDXTime[B crypt.BIDX](f BIDXFunc[B], t time.Time) BIDX[time.Time, B] {
...
func BIDXBool[B crypt.BIDX](f BIDXFunc[B], t bool) BIDX[bool, B] {
	return BIDX[bool, B]{
		bidxFunc: f,
...
func BIDXInt64[B crypt.BIDX](f BIDXFunc[B], t int64) BIDX[int64, B] {
	return BIDX[int64, B]{
		bidxFunc: f,
...
func BIDXFloat64[B crypt.BIDX](f BIDXFunc[B], t float64) BIDX[float64, B] {
